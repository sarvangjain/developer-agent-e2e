# Mermaid Diagram Code - PRD-to-Feature Agent

This file contains all Mermaid diagrams as separate, copy-ready code blocks.  
Paste these into [mermaid.live](https://mermaid.live), GitHub markdown, or any Mermaid-compatible renderer.
...
## Diagram 2: The 4-Layer Retrieval Stack
...
## Diagram 3: Hybrid Search Pipeline (Layer 2 Detail)
...
## Diagram 4: Complete Workflow (Sequence Diagram)
...
## Diagram 5: Phase 1 - Parsing & Repo Map Generation
...
## Diagram 6: Phase 2 - Chunking → Embedding → Indexing
...
## Diagram 7: Comparison - Pure RAG vs Our Approach
...
## Diagram 8: Data Flow - From Codebase to Agent Response
...
### In GitHub/GitLab
1. Paste the code block into a markdown file
